      ...
      <div className="glass-card w-full max-w-4xl rounded-2xl">
        <div className="p-6">
          ...
          <p className="text-gray-300 text-base mb-6">
            The Cyberonites Club invites you to an action-packed event designed
            to enhance your cybersecurity skills. Explore critical concepts,
            gain practical knowledge, and prepare to tackle modern cyber
            threats!
          </p>
                ...
                <div className="space-y-3">
                  ...
                  <a href="https://cyberonites.com">
                    <button
                      ...
                      className={`w-full mt-4 py-2 px-4 rounded-lg font-semibold text-sm transition-all duration-500 ${
                        isHovered
